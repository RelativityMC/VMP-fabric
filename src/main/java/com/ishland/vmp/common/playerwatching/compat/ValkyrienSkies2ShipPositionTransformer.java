...
public class ValkyrienSkies2ShipPositionTransformer extends EntityPositionTransformer {
    ...
    public Vec3d transform0(Entity entity, Vec3d pos) {
        try {
            final Object ship = methodVSGameUtilsKt$getShipManagingPos.invoke(entity.getEntityWorld(), ChunkSectionPos.getSectionCoord(pos.x), ChunkSectionPos.getSectionCoord(pos.z));
            if (ship != null) {
